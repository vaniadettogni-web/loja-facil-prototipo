...
export default function FormularioProduto({ lojaId, onProdutoCriado }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="card" style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 420 }}>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        ...
        <input style={estiloInput} placeholder="Estoque" type="number" value={estoque} onChange={(e) => setEstoque(e.target.value)} required />
      </div>
